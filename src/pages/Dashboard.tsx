...
const Dashboard = () => {
  ...
  return <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <motion.div className="flex-1 container max-w-4xl mx-auto p-3 pb-20" initial={{
      opacity: 0
    }} animate={{
      opacity: 1
    }} transition={{
      duration: 0.6
        ...
        <motion.div className="flex flex-col mb-4" initial={{
        opacity: 0,
        y: -10
      }} animate={{
        opacity: 1,
        ...
        delay: 0.2
          ...
          {currentProject && <div className="mt-3 mb-2 relative w-full max-w-md">
